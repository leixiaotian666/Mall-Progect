...
$sql = "select * from listgoods"; //获取所有列表页的数据
...
$sql1 = "select * from listgoods limit $page,$pagesize";
$res = $conn->query($sql1);
...
// echo $pagenum;
// header("location:http://localhost:8080/Mall-Project/Mall_Project/src/html/goodslist.html?page=$pagenum");
